...
Status Model::SaveWithExternalInitializers(Model& model, int fd, const std::string& external_file_name) {
  if (fd < 0) {
  ...
  auto model_proto = model.ToGraphProtoWithExternalInitializers(external_file_name);
